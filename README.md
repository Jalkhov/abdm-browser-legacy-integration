...
This extension is a port of the official [ab-download-manager-browser-integration](https://github.com/amir1376/ab-download-manager-browser-integration) specifically designed for **XUL-based browsers** (legacy engine). So far, it has been tested and verified on **Palemoon**.
